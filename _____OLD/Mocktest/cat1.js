...
window.onload = async function () {
    try {
        const collectionName='cat_mock1'
...
function loadQuestion(index) {
    ...
    if (questions[index].passage) {
        ...
        questionBox.style.marginTop='300px';
    } else {
...
function submitTest() {
    ...
    const marks = (correctCount * 3) - (incorrectCount * 1); 
 ...
 // Save topic correct counts
    ...
    window.location.href = 'cat_result.html'; // Redirect to results page
}
